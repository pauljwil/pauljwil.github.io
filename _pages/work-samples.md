...
Prometheus exporter for Docker registries that exposes basic registry metrics including repository and tag counts.

[RethinkDB Exporter](https://github.com/pauljwil/rethinkdb-prometheus-exporter)

Fork of an existing RethinkDB exporter that adds new metrics for the `current_issues` table and table sizes, as well as unit testing.
